        ...
        <div class="vacancies-container container">
            ...
            <div class="accordion">
                <div v-for="(job, index) in jobs" :key="index" class="accordion-item">
                    ...
                    <div v-if="activeIndex === index" class="accordion-content">
                        <p>{{ job.description }}</p>
                        <button @click="applyForJob(job.title)" class="apply-button">Подати заявку</button>
                    </div>
                </div>
            </div>
            ...
            <div class="skills-frame">
                <div v-if="activeIndex !== null" class="skills-list">
                    ...
                    <ul>
                        <li v-for="(skill, index) in jobs[activeIndex].skills" :key="index">{{ skill }}</li>
                    </ul>
                </div>
        ...
        return {
            ...
            jobs: [
                ...
                },
                {
                    ...
                    description: 'Менеджер з продажу відповідає за просування продукції заводу у закріпленому за ним регіоні, веде супровід клієнтів, дає консультації по застосуванню препаратів і все відображає у системі CRM. Можливі відрядження. Буде добре, якщо у вас є вже напрацьована база клієнтів.',
                    skills: ['Вища або середня агрономічна освіта (бажано)', 'Розуміння основ сільскогогосподарської галузі', 'Досвід у В2В продажах — 1 рік', 'Вміння або бажання освоїти навики роботи з CRM-системами', 'Зацікавленість у стратегічному розвитку компанії', 'Дисциплінованість, порядність, відповідальність']
                }
            ]
        };
    },
