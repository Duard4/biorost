<template>
    <section class="section about container" id="about-us">
        <div class="text-wrapper">
            ...
            <p class="abuot-text text searchable">
        ...
        <table class="styled-table">
            ...
            <tbody>
                <tr v-for="(row, index) in rows" :key="index" :class="{ active: row.active }" @click="toggleRow(index)">
                    <td><strong>{{ row.category }}</strong></td>
                    <td>
                        <div class="content" v-if="row.active">
...
@media (max-width: 480px) {
    ...
    .styled-table tbody tr.active .content {
        padding: 8px 5px;
    }
}
</style>
